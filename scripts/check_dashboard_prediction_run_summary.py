...
REQUIRED_HTML_TOKENS = [
    'STEP114_PREDICTION_RUN_SUMMARY_STYLE',
    'STEP114_PREDICTION_RUN_SUMMARY_HTML',
    'STEP114_PREDICTION_RUN_SUMMARY_SCRIPT',
    'step114PredictionRunSummaryPanel',
    '予測実行履歴サマリー',
...
def main():
    ...
    print('Dashboard prediction run summary validation: OK')
    print('STEP 115 CHECK: OK')
