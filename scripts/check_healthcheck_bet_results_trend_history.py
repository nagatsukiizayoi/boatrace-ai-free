...
REQUIRED_HTML_TOKENS = [
    "STEP144_BET_RESULTS_TREND_HEALTHCHECK_STYLE",
    "STEP144_BET_RESULTS_TREND_HEALTHCHECK_HTML",
    "STEP144_BET_RESULTS_TREND_HEALTHCHECK_SCRIPT",
    "step144BetResultsTrendHealthPanel",
    "的中判定トレンド Health Check",
    "bet_results_summary_history.json",
    "OK: 的中判定トレンド Health Check を表示しました",
]
...
def main():
    ...
    if isinstance(data, dict):
        ...
        print("healthcheck trend history:")
    ...
    print("Healthcheck bet results trend history validation: OK")
    print("STEP 145 CHECK: OK")
